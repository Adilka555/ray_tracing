...
private:
    void Load() {
        Image_load(&ImgDisk, "data/disk_alpha.png");
        if (!ImgDisk.data){ fprintf(stderr, "not data/disk_alpha.png\n");}
        Image_load(&ImgStars, "data/stars_sp580.png");
        if (!ImgStars.data){ fprintf(stderr, "not data/stars_sp580.png\n");}
